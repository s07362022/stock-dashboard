...
### 變更
- **台股（6 檔）**：
  - 核心：0050×3360（106.3，+57.8%）、2330×25（2440，+13.5%）
  - 衛星：2317×170、2356×1275、2379×3（新）、3481×2250（新，建議減碼）
  - 已移除：00631L、3711（持倉中）
- **美股（10 檔）**：
  - SMH×4（600.31，+27.4%）美股獲利主體
  - 日槓桿待清：ORCX×15、ONDL×59、SPCH×5、MULL×58、SNDU×4
  - SPCX×12（SpaceX，-31%）、ON×6、BB×30、MRVL×1
  - 已移除：HPQ、ASTS、VSH、PLTR；SMH 由 8→4
- **匯率**：USD/TWD = 32.215
- **策略**：本週清日槓桿；群創分批減；7/16 台積法說；10/31 美股變現
- **新標的**：3711／ON／QCOM／NVDA（觀察）寫入 picks／actions

---

## 2026-06-14 17:30 — 券商截圖對帳：台股 6 + 美股 7；ORCX 待出清

**Commit**: `(待 push)` — `update: portfolio 2026-06-14 screenshot sync`

### 變更
- **台股（6 檔）**：
  - 核心：0050×3210（101.95，+55.5%）、00631L×5650（34.83，+14.4%）、2330×25（2310，+7.4%）
  - 衛星：2317×170（260.5，-12.5%）、2356×1130（66.2，-7.8%）、3711×20（590，+3.3%）新增
- **美股（7 檔）**：
  - SMH×8（619.96，+31.5%）最大美股部位
  - ORCX×13（37.32，-36.5%）槓桿 ETF 待出清
  - HPQ×27、ASTS×5、VSH×7、MRVL×1、PLTR×1
  - 已移除：NVDA、DRAM、AMZN、RKLB
- **匯率**：USD/TWD = 31.63
- **總市值** NT$945,542；總損益 +NT$155,805（+19.73%）
- **台股佔比** 75%；美股佔比 25%

### 策略重點
- 🔴 6/16 週一優先出清 ORCX×13（槓桿 ETF -36.5%）
- 🟢 核心 0050/00631L/2330 永久不動
- 🟡 SMH×8 守 $580；9 月起分批出清
- 6/17 FOMC Warsh 首次聲明為本週最大催化劑

---


**Commit**: `update: portfolio 2026-06-14 post-execution, FOMC week strategy`

### 變更
- **已執行操作（6/8）**：CWVX×4、ORCX×10 全出清 ✓；SMH 從 8 股減至 4 股 ✓
- **台股（5 檔，6/12 收盤）**：
  - 核心：0050×3210（101.95，+54.6%）、00631L×5350（34.83，+15.7%）、2330×25（2310，+7.7%）
  - 衛星：2317×170（260.5，-12.0%）、2356×1000（68.0，-5.2%）
- **美股（8 檔，6/12 收盤）**：
  - SMH×4（619.50，+31.4%）、HPQ×27（25.24，-10.8%）、ASTS×4（87.75，-16.6%）
  - NVDA×1（204.87，-12.7%）、VSH×5（59.38，-5.1%）、DRAM×2（65.01，+3.6%）
  - AMZN×1（238.55，-6.0%）、RKLB×1（102.39，-10.3%）
- **大盤（6/12）**：台股加權 44,169（+1,019，+2.36%）；SMH $619.50（+1.65%）；VIX 17.8
- **本週焦點**：6/17 FOMC 新主席 Warsh 首次聲明；6/24 NVDA 股東大會＋美光財報
- **總市值** NT$824,744（↓ 自 941k，因出清槓桿 ETF 及市價下調）
- **總損益** +NT$146,992（+21.69%）；美股 8 檔 +$371.80（+9.0%）
- **台股佔比** 83%；美股佔比 17%

### 策略重點
- FOMC 6/17 前靜候：Warsh 鴿派→持守；鷹派→加速 7-8 月美股減碼
- 6/24 NVDA 股東大會前不輕動；美光財報確認記憶體景氣
- 核心 0050/00631L/2330 永久不賣
- 10/31 變現硬約束：9/1 起 SMH 每週減 25-30%
...
### 變更
- **修正**：0050/00631L/2330 為長期核心持有（**未賣**），不在操作範圍
- **現金**：五月賣出回收 25 萬，計畫投入 20 萬，留 5 萬緩衝
- **台股 5 檔（≤1000）**：2317 鴻海、3231 緯創、2382 廣達、2303 聯電、2337 旺宏
- **美股 5 檔（≤$300）**：ORCL、ANET、MRVL、DDOG、CRWV
- **變現**：9 月起每週賣 20-25%，10/25 前清成長倉，10/31 用錢
...
### 變更
- **持倉**：出清 QCMU/ANEL/PLTU/QCOM/3711；新增 DDOG×4；0050 3210 股
- **報價**：5/29 收盤（TWII ~44954；S&P 7580；SMH 598.93；DDOG 247.35）
- **總市值**：NT$738,324（台股 75.6% / 美股 24.4%）
- **策略**：12 萬三個月成長 → ORCL/ANET/6669；00631L 高檔控槓桿
- **新聞/財報/潛力股**：COMPUTEX、Dell/DDOG/ORCL 大漲、Fed 6 月維持利率

---

## 2026-05-22 — 深度報告同步（5/21 報價）

### 更新內容
- **報價**：台股 5/21 收盤（0050 95.85、2330 2230、3711 510）；美股 5/21 美東（SMH 562.45、QCMU 34.27、NVDA 219.29）
- **大盤**：台股加權 41,368（+3.36%）；NVDA 財報 816 億
- **總市值**：腳本重建（約 NT$800,312）
- **策略**：減碼 QCMU；守 0050/2330/SMH；3711 停損 450
- **新聞/財報/潛力股**：同步 5/21 事件與 2454/6669/3443/AMD/ANET

---

## 2026-05-19（二次）— 持倉大調整：截圖同步

### 更新內容
- **台股**：0050×3110、00631L×4350、2330×25、3711×30；移除 00830、2337
- **美股**：SMH×7、QCMU×95、ANEL×45、QCOM×2、PLTU×10、CSCO×3、NVDA×1
- **出清**：AVGO、MULL、ONDL、AIXI、TSLT、TSMG、SNDU、VSH
- **匯率**：31.65
- **total市值**：腳本重建後更新
- **策略**：QCMU 減碼；守 0050/2330/SMH

---

## 2026-05-19 — 科技回檔日：同步 portfolio.md + 5/19 報價

### 更新內容
- **持倉同步**：依 `portfolio.md`（2026-05-12 美股截圖）— AVGO×5、SMH×6、QCMU×71、MULL×1、ANEL×55、TSLT×35、TSMG×15、SNDU×2、ONDL×30、VSH×5、AIXI×3；移除 PLUG/LNOK 舊資料
- **台股 5/19**：加權 -716pts 收 40,176；0050 93.1、2330 2205、旺宏 -10% 跌停、日月光 -7.45%
- **美股 5/18**：SMH -1.83%、AVGO -1.05%、MULL -11.84%、ONDL -17.71%；10Y 美債 ~4.59%
- **策略**：降槓桿堆疊；AIXI/ONDL 出清；守 AVGO/SMH/2330
- **潛力股**：信驊、創意、緯穎、ANET、ORCL
- **total市值**：NT$871,032（+12.46%）
- **驗證**：23 keys + 14 sub-structure 全通過

---

## 2026-05-14（四次更新）— ONDS財報爆炸ONDL策略180度翻轉！QCMU盤前-6.72%繼續承壓

### 更新內容
- **🔥 ONDS Q1 2026破紀錄財報**：Q1營收$50.1M年增10倍(超指引25%)；全年展望上修$3.9億(+670%)；積壓訂單$457M(+569%)；EBITDA提前6個月轉正！
- **ONDL策略翻轉**：從「出清」改為「持有」；價格$13.24→**$16.71**盤前(+26.22%)；tag從exit→satellite；撤銷GTC$13.80出清令
- **QCMU盤前更新**：-6.72%至$34.03（從早上-9.27%稍微收斂）；仍在$34警戒線附近
- **LNOK盤前續漲**：+8.13%至$97.80（連兩日暴漲）
- **total市值**：NT$877,020（+20.21%）
- **今日操作結論**：已完整輸出（含六大區塊+ONDL逆轉分析）

---

## 2026-05-14（三次更新）— 美股價格驗證修正 + LNOK爆漲+QCMU警示

### 更新內容
- **價格修正**：PLUG $3.87→**$3.96**（+11.24% BigGo確認）；LNOK $87.83→**$90.45**（+24.76% BigGo確認）
- **LNOK暴漲原因**：Nokia Q1 AI雲端訂單+49%；CAGR指引上調至27%；新CEO；法律勝訴 → LNOK(2×) +24.76%
- **QCMU盤前警示**：5/14盤前 **-9.27% = $33.10**（QCOM Apple份額流失+Android疲弱+分析師質疑基本面），underlying_analysis 已更新
- **total市值**：NT$874,840（+19.91%）
- **驗證**：14項sub-structure全通過

---

## 2026-05-14（二次更新）— 台股+377pt收41,752 + S&P歷史新高 + 5檔潛力股更新

### 更新內容
- **台股 5/14 收盤**：加權 **41,751.75（+377.25，+0.91%）**；台積電 **+50元收2,270**；日月光 548（平盤）；0050 **96.05(+0.58%)**；00631L ~32.20(+1.10%)；旺宏 172(+2.38%)；成交 1.22 兆
- **美股指數更新**：S&P 500 **7,444.25（歷史新高，+0.58%）**；NASDAQ 歷史高點（+1.19%）；SMH 5/13 實際收盤 **$572.46(+2.00%)**
- **QCMU 價格修正**：5/13 實際收盤 **$36.48**（前次用盤中高點$37.97已修正）；5/14 盤前 **-6.83% = $33.99** ⚠️ 需關注
- **川習峰會**：正向聲明「貿易戰無贏家」；美中擬各降300億商品關稅；習警告台灣問題
- **5 檔潛力股更新**：旺宏2337(↑57%)、世芯3661(↑49%)、聯發科2454(↑27%)、AMD(↑33%)、ORCL(↑28%)
- **匯率**：31.515 → **31.405**
- **總市值**：NT$874,537（+19.87%）
- **驗證**：`Required keys missing: NONE`；全 14 項 sub-structure 通過

---

## 2026-05-14 — 持倉大幅重組 + PLUG財報超預期 + 美股V形反彈

### 更新內容
- **持倉重組（截圖確認）**：出清 AVGO/AIXI/MULL/SNDU/VSH；加碼 QCMU(71→**92股**，均攤$40.41→$39.42)；SMH(6→**7股**，avg $454.73)；減碼 ONDL(30→**20股**)；🆕 新增 LNOK(2×Nokia ETF)×3、🆕 PLUG(Plug Power)×20
- **美股 5/13 盤中（台灣時間5/14凌晨）**：QCMU **+6.9%**=$37.97；TSLT **+7.6%**=$23.88；SMH **+2.2%**=$573.62；AVGO -0.49%=$417.22
- **🔥 PLUG Q1 2026 財報**：EPS -$0.08（超預期-$0.09）；營收$163M +22%；毛利率改善至-13%（自-55%）；今日+14.5%
- **分析師上調 PLUG**：B.Riley $5.00、HC Wainwright $7.00、Canaccord $4.00
- **台股 5/13**：加權 41,374.5(-1.25%)；2337 漲停+9.8%；匯率 31.415→31.515
- **總市值**：NT$876,792（+20.0%）
- **驗證**：`Required keys missing: NONE`；全 14 項 sub-structure 通過

---

## 2026-05-13 — 盤後更新：旺宏漲停、QCMU暴跌、台股大跌、川習會

### 更新內容
- **台股 5/13 收盤**：旺宏(2337) 漲停+9.8%收168元；台積電(2330) -1.55%收2,220；日月光(3711) -1.26%收548；加權 -1.25%收41,374
- **美股 5/12 收盤**：⚠️ QCMU 實際收盤 **-23.0%** 至 $35.52（截圖$45.10為盤中數據）；ANEL **+8.8%**至$16.08；SMH -2.61%收$561.25；AVGO -2.13%收$419.30；MULL估$491.25；ONDL -8.35%收$13.72；TSLT -5.58%收$22.18
- **總市值**：NT$911,850（+17.73%）
- **操作建議更新**：立即出清AIXI/ONDL；QCMU減碼50%+；旺宏/日月光/台積電核心持有
- **新聞**：5/13旺宏NOR缺貨爆發、川習會北京登場、美4月CPI 3.8%超預期、QCOM-11.4%
- **picks**：更新台3（旺宏/聯發科/信驊）美2（ORCL/AMD）
- **analysts**：QCMU票從6/8/5更新至10/7/2（強力減碼）；旺宏從2/9/8更新至1/4/14（強力買進）
